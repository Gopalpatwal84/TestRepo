namespace BusinessPlatform.Jobs.Web.Services
{
    using System;
    ...
    public class MessageBroadcastService
    {
        ...
        {
            var storageConnectionInfos = serviceSettings.ServiceGroups.Single(g => g.Name == "BusinessPlatform-jobs");
            ...
            this.mediators = storageConnectionInfos
                .StorageConnections
        ...
        public class RegionSlot
        {
            ...
            {
                return string.Format("{0} ({1})", this.Region, this.Slot);
            }
        }
    }
}