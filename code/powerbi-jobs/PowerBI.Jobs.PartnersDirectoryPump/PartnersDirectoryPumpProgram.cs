...
namespace PowerBI.Jobs.PartnersDirectoryPump
{
    public class PartnersDirectoryPumpProgram
    {
        ...
        {
            return s_container.HandleCommand(new RefreshPartnersDirectoryCommand { Source = ReadSource.Remote, }, log);
        }

        public static Task ProcessMessage([QueueTrigger("%RefreshPartnersDirectoryCommand%")] RefreshPartnersDirectoryCommand command, TextWriter log)
        {
